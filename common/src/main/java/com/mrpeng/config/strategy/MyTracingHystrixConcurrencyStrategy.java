 ...
 * @author pengquan
 * @version 1.0
 * @classname MyTracingHystrixConcurrencyStrategy
 * @description 类描述
...
public class MyTracingHystrixConcurrencyStrategy extends HystrixConcurrencyStrategy {

    private HystrixConcurrencyStrategy delegate;

    public MyTracingHystrixConcurrencyStrategy() {
        try {
